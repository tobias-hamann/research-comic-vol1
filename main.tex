...
We wanted to take the concept of multilangual rendering further by allowing languages with non-latin letters to be displayed as well.
Hence, Draconic was used as a proof-of-concept approach, as it is rendered in the Iokharic script.
The translation was conducted by \ac{ai} and reviewed by human.
It is based on the draconic language as invented by Stephens et al. \cite{STEP01, MOSB26}.
