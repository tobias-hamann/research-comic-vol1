...
%   \objective*      am Ende des Abstracts   (Sternform, siehe dort)
...
%
% SciKGTeX: \objective und \researchproblem stehen hier als Sternform.
% Ihr Fliesstext enthaelt ein \cite, und der Lua-Stripper des Pakets macht
% daraus im XMP den nackten BibTeX-Key. Die Sternform setzt keinen Text,
% sie schreibt nur in die Metadaten -- der Wert ist also derselbe Satz wie
% oben, nur ohne das \cite. \method und \result bleiben direkt im Text,
% weil sie keine Zitate enthalten.
\objective*{Comics journalism constitutes a graphic form of literary journalism. According to John S. Bak and Christopher Craig, comics journalism and literary journalism share key features: they both read like fiction but are based on immersive research, eyewitness accounts, and verifiable facts scrutinized as closely as possible.}%
