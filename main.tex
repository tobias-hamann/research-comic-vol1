...
Every language \verb|CODE| is kept in its own folder \path{language_files/CODE}, which holds the text file \path{CODE.tex}, the corresponding folder \path{pages_CODE} and all language dependent images. Here, \verb|CODE| is the lowercase three-letter identifier from ISO 639 Set 3 (formerly ISO 639-3) \cite{iso_639_2023}, as used by the Zenodo language vocabulary.
