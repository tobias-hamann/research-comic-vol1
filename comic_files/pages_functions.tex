...
% Sprachordner, z.B.
%   language_files/elb/fonts_elb.tex        <- \newfontfamily und \FDISetLanguageFonts
%   language_files/elb/fonts_elb/tngani.ttf <- die Schriftdatei
...
% in der Datei fonts_XY.tex im jeweiligen Sprachordner. Sprachen ohne
...
% Ordner mit den sprachspezifischen Schriften, z.B. language_files/elb/fonts_elb
...
% Available languages
% ------------------------------------------------------------
% Eine neue Sprache XY wird hier eingetragen und braucht den Ordner
% language_files/XY mit XY.tex, pages_XY und optional fonts_XY.tex.

\newcommand{\FDILanguageList}{de,en,la,elb}
...
\FDISetLanguageName{de}{German}
\FDISetLanguageName{en}{English}
\FDISetLanguageName{la}{Latin}
\FDISetLanguageName{elb}{Elvish}

% ------------------------------------------------------------
% Input language specific fonts
% ------------------------------------------------------------
% Gehoert in die Praeambel, weil \newfontfamily nur dort erlaubt ist.
% Laedt language_files/XY/fonts_XY.tex fuer jede Sprache, die so eine
...
% Usage: \FDIComicSection{de}
%        \FDIComicSection[3-5]{de}
% ------------------------------------------------------------
...
% ------------------------------------------------------------
% Jump to navigation
% Usage: \FDIJumpTo{article,en,de,la,elb}
% ------------------------------------------------------------
