...
\newcommand{\FDILanguageList}{deu,eng,vss}
...
% Project-local identifier; vss is not registered in ISO 639 or Zenodo.
...
% \FDIStyledText{schriftgröße}{legacy-wert (ignoriert)}{text}
% Der Zeilenabstand kommt für alle Aufrufe aus \FDITextLineSkip.
...
% x und y bezeichnen den Startpunkt des Bogens. Text ist von außen lesbar.
...
% x und y bezeichnen den Startpunkt des Bogens. Text ist von innen lesbar.
...
% FDI city dots
% ------------------------------------------------------------
% \FDICityDot{x}{y}{mindestdurchmesser}{füllfarbe}
